...
app_description = "The Task Manager app is a comprehensive tool designed to streamline task management for individuals or teams. With intuitive features and a user-friendly interface, it enables users to efficiently organize, track, and prioritize tasks to boost productivity and meet project deadlines effectively."
app_email = "mailtotaskmanager@gmail.com"
app_license = "mit"
# required_apps = []
